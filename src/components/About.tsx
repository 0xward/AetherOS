...
import { EcoBadgeGrid } from '@/components/EcosystemBadges';

const faqs = [
  {
    q: 'What is AetherOS?',
    a: 'AetherOS is an AI-powered professional network intelligence platform built natively on the Stacks blockchain (Bitcoin L2). Beyond a 7-step AI strategy engine, it now includes sBTC warm-intro bounties, non-transferable on-chain certificate badges, a Gaia-first private CRM, and AI-drafted outreach — all anchored to Bitcoin.',
  },
  {
  ...
  {
    q: 'What are sBTC Warm Intro Bounties?',
    a: 'Anyone can pledge sBTC to request a warm introduction to a target person or company. Contributors submit proof of the intro, and the bounty creator approves it — releasing sBTC wallet-to-wallet. Bounties are recorded on the on-chain aetheros-bounty-registry contract, and AetherOS never holds your funds.',
  },
  {
    q: 'What are the on-chain certificate badges?',
    a: 'AetherOS issues non-transferable SBT certificates via the aetheros-certificate-sbt contract on Stacks mainnet. They act as a tamper-proof, Bitcoin-secured reputation record of your verified contributions and milestones.',
  },
  {
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        >
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass-card border border-white/10 mb-4">
              <div className="w-1.5 h-1.5 rounded-full bg-orange-400 animate-pulse" />
              <span className="text-xs font-mono text-white/40 tracking-widest uppercase">Powered By</span>
            </div>
            <h3 className="font-display text-3xl md:text-4xl font-bold mb-3">
              <span className="text-white">Built On</span>{' '}
              <span className="gradient-text-purple-green">The Best Stack</span>
            </h3>
            <p className="text-white/40 text-sm max-w-xl mx-auto">
              AetherOS is assembled from battle-tested, production-grade technology — from Bitcoin&apos;s security layer down to the AI inference engine.
            </p>
          </div>
          <EcoBadgeGrid />
        </motion.div>
